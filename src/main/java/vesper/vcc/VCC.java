...
public class VCC implements ModInitializer {
    ...
    public static final String[] launchMsg = {"I just hit things with hammers until they work", "Oh look! A penny!", "Would you be moved in with by me?"};

    @Override
    public void onInitialize() {
        int randomMsg = RandomSource.create().nextIntBetweenInclusive(0, launchMsg.length - 1);
        LOGGER.info(launchMsg[randomMsg]);
        //DashKeyBind.init();
    }
}
